...
//Access print time through base point
cout << endl;
...
// Use virtual functions or downcasting

// example of down casting..

MilliTime * MilliTimePtr;

MilliTimePtr = dynamic_cast <MilliTime *> (BasePtr);

cout << endl;
cout << "Accessing With Downcasting" <<endl;
MilliTimePtr->printTime(); 
cout << endl;
